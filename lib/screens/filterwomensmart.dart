...
import './filterbothsmart.dart';
import 'package:adobe_xd/page_link.dart';
import './filterwomenformal.dart';
import './filtermensmart.dart';
import './filterwomencasual.dart';
import './ShirtsWomenSmartCasual.dart';
import './Shirts.dart';
import 'package:flutter_svg/flutter_svg.dart';

class filterwomensmart extends StatelessWidget {
  filterwomensmart({
    Key? key,
  }) : super(key: key);
  @override
            ...
            child:
              ...
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => ShirtsWomenSmartCasual(),
                ),
              ],
              child: Stack(
                children: <Widget>[
...
const String _svg_qm6a02 =
    '<svg viewBox="0.0 0.0 119.0 36.0" ><path  d="M 18 0 L 101 0 C 110.9411239624023 0 119 8.058874130249023 119 18 C 119 27.94112586975098 110.9411239624023 36 101 36 L 18 36 C 8.058874130249023 36 0 27.94112586975098 0 18 C 0 8.058874130249023 8.058874130249023 0 18 0 Z" fill="#11123a" stroke="#ffffff" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
