...
import './filtermenfrml.dart';
import './filtermencasual.dart';
import './filterwomensmart.dart';
import './ShirtsMenSmartCasual.dart';
import './Shirts.dart';
import 'package:flutter_svg/flutter_svg.dart';

class filtermensmart extends StatelessWidget {
  filtermensmart({
    Key? key,
  }) : super(key: key);
  @override
            ...
            child:
              ...
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => ShirtsMenSmartCasual(),
                ),
              ],
              child: Stack(
                children: <Widget>[
