...
class ShirtsBothCasual extends StatelessWidget {
  ShirtsBothCasual({
    Key? key,
  }) : super(key: key);
  @override
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            ...
            Pin(size: 523.2, end: 68.4),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(start: 0.0, end: 0.0),
                  Pin(size: 343.1, start: 0.0),
                  child: Stack(
                    children: <Widget>[
                      Pinned.fromPins(
                ...
                Pinned.fromPins(
                  ...
                  Pin(size: 345.6, end: 0.0),
                  child: Stack(
                    children: <Widget>[
                      Pinned.fromPins(
                        Pin(size: 101.5, middle: 0.5066),
                        Pin(size: 163.4, start: 0.0),
                        child: Stack(
                          children: <Widget>[
                            Pinned.fromPins(
                              Pin(start: 0.0, end: 0.0),
                      ...
                      Pinned.fromPins(
                        Pin(size: 101.0, middle: 0.5054),
                        Pin(size: 170.4, end: 0.0),
                        child: Stack(
                          children: <Widget>[
                            Pinned.fromPins(
                          ...
                          children: <Widget>[
                            ...
                            Pinned.fromPins(
                              ...
                              child:
                                ...
                                decoration: BoxDecoration(
                                  image: DecorationImage(
                                    image: const AssetImage('assets/images/wommencasual3.png'),
                                    fit: BoxFit.fill,
                                  ),
                                ),
                              ),
