...
import './Shirtshome1.dart';
import 'package:adobe_xd/page_link.dart';
import './Shirtshome3.dart';
...
class Shirtshome2 extends StatelessWidget {
  Shirtshome2({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(startFraction: 0.1333, endFraction: 0.6861),
            ...
            child: Stack(
              children: <Widget>[
                ...
                Pinned.fromPins(
                  ...
                  child:
                      // Adobe XD layer: 'women casual 3' (shape)
                      Container(
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: const AssetImage('assets/images/womencasual3.png'),
                        fit: BoxFit.fill,
                      ),
                    ),
                  ),
          ...
          Pinned.fromPins(
            Pin(size: 103.3, middle: 0.4987),
            Pin(size: 170.9, middle: 0.2141),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(start: 0.0, end: 7.3),
                  Pin(size: 28.0, end: 0.0),
                  child: Stack(
                    children: <Widget>[
                      Pinned.fromPins(
                ...
                Pinned.fromPins(
                  ...
                  Pin(size: 137.3, start: 0.0),
                  child:
                      // Adobe XD layer: 'men frml 2' (shape)
                      Container(
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: const AssetImage('assets/images/womenfrml2.png'),
                        fit: BoxFit.fill,
                      ),
                    ),
                  ),
          ...
          Pinned.fromPins(
            Pin(size: 101.9, end: 15.0),
            Pin(size: 169.4, middle: 0.2167),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                ...
                Pinned.fromPins(
                  Pin(start: 0.0, end: 0.0),
                  Pin(start: 0.0, end: 33.2),
                  child:
                      // Adobe XD layer: 'men semi frml 1' (shape)
                      Container(
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: const AssetImage('assets/images/mensemifrml1.png'),
                        fit: BoxFit.fill,
                      ),
                    ),
                  ),
          ...
          Pinned.fromPins(
            Pin(size: 102.0, start: 16.7),
            Pin(size: 165.3, middle: 0.5112),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(start: 0.0, end: 6.0),
                ...
                Pinned.fromPins(
                  ...
                  child:
                      // Adobe XD layer: 'men semi frml 2' (shape)
                      Container(
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: const AssetImage('assets/images/mensemifrml2.png'),
                        fit: BoxFit.fill,
                      ),
                    ),
                  ),
          ...
          Pinned.fromPins(
            Pin(size: 102.9, middle: 0.4984),
            Pin(size: 165.5, middle: 0.5111),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
            ...
            child: Stack(
              children: <Widget>[
                ...
                Pinned.fromPins(
                  ...
                  Pin(start: 0.0, end: 29.0),
                  child:
                      // Adobe XD layer: 'women forml shrt 3' (shape)
                      Container(
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: const AssetImage('assets/images/menfrmlshrt3.png'),
                        fit: BoxFit.fill,
                      ),
                    ),
                  ),
          ...
          Pinned.fromPins(
            Pin(size: 20.0, middle: 0.4324),
            Pin(size: 20.0, end: 73.0),
            child: PageLink(
              links: [
                PageLinkInfo(
                  transition: LinkTransition.Fade,
          ...
          Pinned.fromPins(
            Pin(size: 29.0, middle: 0.6586),
            Pin(size: 14.0, end: 76.0),
            child: PageLink(
              links: [
                PageLinkInfo(
                  transition: LinkTransition.Fade,
          ...
          Pinned.fromPins(
            Pin(size: 103.3, start: 16.7),
            Pin(size: 168.8, end: 111.0),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(start: 0.0, end: 7.3),
                ...
                Pinned.fromPins(
                  Pin(start: 0.6, end: 0.0),
                  Pin(size: 133.4, start: 0.0),
                  child:
                      // Adobe XD layer: 'men semi frml 3' (shape)
                      Container(
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: const AssetImage('assets/images/mensemifrml3.png'),
                        fit: BoxFit.fill,
                      ),
                    ),
                  ),
          ...
          Pinned.fromPins(
            ...
            child: Stack(
              children: <Widget>[
                ...
                Pinned.fromPins(
                  Pin(start: 0.0, end: 0.0),
                  Pin(start: 0.0, end: 33.7),
                  child:
                      // Adobe XD layer: 'women forml shrt 2' (shape)
                      Container(
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: const AssetImage('assets/images/womenformlshrt2.png'),
                        fit: BoxFit.fill,
                      ),
                    ),
                  ),
            ...
            child: Stack(
              children: <Widget>[
                ...
                Pinned.fromPins(
                  ...
                  Pin(start: 0.0, end: 33.7),
                  child:
                      // Adobe XD layer: 'women semi casual 2' (shape)
                      Container(
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: const AssetImage('assets/images/womensemicasual2.png'),
                        fit: BoxFit.fill,
                      ),
                    ),
                  ),
