    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
                      ...
                      child: Stack(
                        children: <Widget>[
                              ...
                              child: Stack(
                                children: <Widget>[
                                  Pinned.fromPins(
                                    ...
                                    Pin(start: 0.0, end: 0.0),
                                    child:
                                        // Adobe XD layer: 'cat6' (shape)
                                        Container(
                                      decoration: BoxDecoration(
                                        image: DecorationImage(
                                          image: const AssetImage('assets/images/cat6.png'),
                                          fit: BoxFit.fill,
                                        ),
                                      ),
                                    ),
                                  ...
                                  Pinned.fromPins(
                                    Pin(size: 26.0, middle: 0.5032),
                                    Pin(size: 11.0, end: 30.0),
                                    child: Text(
                                      'TOPS',
                                      style: TextStyle(
                                        ...
                                        letterSpacing: 1.3846154479980468,
                                      ),
                          ...
                          Pinned.fromPins(
                            ...
                            Pin(size: 175.0, middle: 0.36),
                            child:
                                // Adobe XD layer: 'cat5' (group)
                                PageLink(
                              links: [
                                PageLinkInfo(
                                  transition: LinkTransition.Fade,
                              ...
                              child: Stack(
                                children: <Widget>[
                                  Pinned.fromPins(
                                    ...
                                    Pin(start: 0.0, end: 0.0),
                                    child:
                                        // Adobe XD layer: 'cat5' (shape)
                                        Container(
                                      decoration: BoxDecoration(
                                        image: DecorationImage(
                                          image: const AssetImage('assets/images/cat5.png'),
                                          fit: BoxFit.fill,
                                        ),
                                      ),
                                    ),
                          ...
                          Pinned.fromPins(
                            ...
                            child:
                              ...
                              children: <Widget>[
                                ...
                                Pinned.fromPins(
                                  Pin(size: 74.0, middle: 0.5049),
                                  Pin(size: 11.0, middle: 0.8171),
                                  child: Text(
                                    'ACCESSORIES',
                                    style: TextStyle(
                                      fontFamily: 'Quicksand',
                          ...
                          Pinned.fromPins(
                            ...
                            child:
                              ...
                              children: <Widget>[
                                ...
                                Pinned.fromPins(
                                  Pin(size: 34.0, middle: 0.5035),
                                  Pin(size: 11.0, middle: 0.8121),
                                  child: Text(
                                    'PANTS',
                                    style: TextStyle(
                                      fontFamily: 'Quicksand',
                          ...
                          Pinned.fromPins(
                            Pin(size: 175.0, start: 0.0),
                            Pin(size: 175.0, middle: 0.6421),
                            child:
                                // Adobe XD layer: 'cat2' (group)
                                PageLink(
                              links: [
                                PageLinkInfo(
                                  transition: LinkTransition.Fade,
          ...
          Pinned.fromPins(
            Pin(startFraction: 0.1306, endFraction: 0.575),
          ...
          Pinned.fromPins(
            Pin(start: 40.9, end: 40.9),
            Pin(size: 40.3, end: 21.8),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(start: 0.0, end: 0.0),
                ...
                Pinned.fromPins(
                  Pin(size: 15.5, end: 13.8),
                  Pin(size: 14.4, middle: 0.4922),
                  child:
                ...
                Pinned.fromPins(
                  Pin(size: 16.3, middle: 0.7189),
                  Pin(size: 14.8, middle: 0.4936),
                  child:
