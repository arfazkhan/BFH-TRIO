...
class Shirtshome1 extends StatelessWidget {
  Shirtshome1({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 101.4, start: 15.0),
            Pin(size: 170.0, middle: 0.2153),
            child: PageLink(
              links: [
                PageLinkInfo(
                  transition: LinkTransition.Fade,
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromPins(
                    Pin(start: 0.0, end: 0.0),
                    Pin(start: 0.0, end: 34.5),
                    child:
                        // Adobe XD layer: 'men frml shrt 3' (shape)
                        Container(
                      decoration: BoxDecoration(
                        image: DecorationImage(
          ...
          Pinned.fromPins(
            Pin(size: 102.0, end: 14.8),
            Pin(size: 170.3, middle: 0.2154),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(start: 0.0, end: 0.0),
                  Pin(start: 0.0, end: 34.1),
                  child:
                      // Adobe XD layer: 'women forml shrt 1' (shape)
                      Container(
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: const AssetImage('assets/images/womenformlshrt1.png'),
                        fit: BoxFit.fill,
                      ),
                    ),
                  ),
          ...
          Pinned.fromPins(
            Pin(size: 101.5, start: 15.0),
            Pin(size: 163.4, middle: 0.5128),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(start: 0.0, end: 0.0),
                  ...
                  child:
                      // Adobe XD layer: 'women casual 1' (shape)
                      Container(
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: const AssetImage('assets/images/womencasual1.png'),
                        fit: BoxFit.fill,
                      ),
                    ),
                  ),
            ...
            child: Stack(
              children: <Widget>[
                ...
                Pinned.fromPins(
                  ...
                  Pin(size: 129.7, start: 0.0),
                  child:
                      // Adobe XD layer: 'women casual 2' (shape)
                      Container(
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: const AssetImage('assets/images/womencasual2.png'),
                        fit: BoxFit.fill,
                      ),
                    ),
                  ),
          ...
          Pinned.fromPins(
            Pin(size: 102.7, end: 13.8),
            Pin(size: 163.4, middle: 0.5128),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(start: 0.0, end: 6.7),
                  Pin(size: 29.0, end: 0.0),
                  child: Stack(
                    children: <Widget>[
                      Pinned.fromPins(
                ...
                Pinned.fromPins(
                  ...
                  Pin(start: 0.0, end: 33.7),
                  child:
                      // Adobe XD layer: 'men frml shrt 1' (shape)
                      Container(
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: const AssetImage('assets/images/menfrmlshrt1.png'),
                        fit: BoxFit.fill,
                      ),
                    ),
                  ),
          ...
          Pinned.fromPins(
            Pin(size: 102.0, start: 14.5),
            Pin(size: 170.4, end: 110.6),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(start: 0.0, end: 0.0),
          ...
          Pinned.fromPins(
            Pin(size: 101.0, middle: 0.5083),
            Pin(size: 170.4, end: 110.6),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(start: 0.3, end: 4.6),
                  Pin(size: 29.0, end: 0.0),
                  child: Stack(
                    children: <Widget>[
                      Pinned.fromPins(
                ...
                Pinned.fromPins(
                  ...
                  Pin(start: 0.0, end: 34.0),
                  child:
                      // Adobe XD layer: 'women casual 4' (shape)
                      Container(
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: const AssetImage('assets/images/womencasual4.png'),
                        fit: BoxFit.fill,
                      ),
                    ),
                  ),
            ...
            child: Stack(
              children: <Widget>[
                ...
                Pinned.fromPins(
                  ...
                  Pin(start: 0.0, end: 34.0),
                  child:
                      // Adobe XD layer: 'women semi casual 1' (shape)
                      Container(
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: const AssetImage('assets/images/womensemicasual1.png'),
                        fit: BoxFit.fill,
                      ),
                    ),
                  ),
