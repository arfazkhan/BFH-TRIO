                        ...
                        child:
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(17.0),
                              image: DecorationImage(
                                image: const AssetImage('assets/images/frmls.png'),
                                fit: BoxFit.fill,
                              ),
                            ),
                          ),
                      ...
                      Pinned.fromPins(
                        ...
                        child:
                          ...
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(17.0),
                            image: DecorationImage(
                              image: const AssetImage('assets/images/n95.png'),
                              fit: BoxFit.fill,
                            ),
                          ),
                        ),
                                ...
                                Pinned.fromPins(
                                  ...
                                  child:
                                    ...
                                    decoration: BoxDecoration(
                                      borderRadius: BorderRadius.circular(17.0),
                                      image: DecorationImage(
                                        image: const AssetImage('assets/images/20off.png'),
                                        fit: BoxFit.fill,
                                      ),
                                    ),
                                  ),
...
const String _svg_zgkzhy =
    '<svg viewBox="-4224.2 -2806.0 20.4 1.0" ><path transform="translate(-4224.18, -2806.0)" d="M 0 0 L 20.36666679382324 0" fill="none" stroke="#707070" stroke-width="5" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_1nak3e =
    '<svg viewBox="-4224.2 -2799.5 20.4 1.0" ><path transform="translate(-4224.18, -2799.5)" d="M 0 0 L 20.36666679382324 0" fill="none" stroke="#707070" stroke-width="5" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_olsmo =
    '<svg viewBox="-4224.2 -2793.0 20.4 1.0" ><path transform="translate(-4224.18, -2793.0)" d="M 0 0 L 20.36666679382324 0" fill="none" stroke="#707070" stroke-width="5" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
