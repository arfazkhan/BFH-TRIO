...
class ShirtsBothFormal extends StatelessWidget {
  ShirtsBothFormal({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(start: 16.0, end: 15.3),
            Pin(size: 170.9, middle: 0.2363),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(size: 101.4, start: 0.0),
                    ...
                    children: <Widget>[
                      ...
                      Pinned.fromPins(
                        ...
                        child:
                          ...
                          decoration: BoxDecoration(
                            image: DecorationImage(
                              image: const AssetImage('assets/images/menfrmlshrt2.png'),
                              fit: BoxFit.fill,
                            ),
                          ),
                        ),
