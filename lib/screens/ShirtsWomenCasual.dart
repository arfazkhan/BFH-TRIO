...
class ShirtsWomenCasual extends StatelessWidget {
  ShirtsWomenCasual({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(start: 20.0, end: 20.5),
            Pin(size: 345.6, middle: 0.321),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
