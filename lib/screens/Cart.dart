    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(startFraction: 0.1834, endFraction: 0.311),
          ...
          Pinned.fromPins(
            Pin(startFraction: -0.1639, endFraction: 0.1472),
          ...
          Pinned.fromPins(
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromPins(
                    Pin(startFraction: 0.4911, endFraction: 0.3086),
                    Pin(size: 20.0, middle: 0.9167),
                    child:
                  ...
                  Pinned.fromPins(
                    Pin(startFraction: 0.4911, endFraction: 0.0),
                    Pin(size: 38.0, middle: 0.5995),
                    child:
          ...
          Pinned.fromPins(
            Pin(size: 75.0, middle: 0.4737),
            Pin(size: 50.0, middle: 0.8),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(startFraction: 0.0, endFraction: 0.0),
                  Pin(size: 25.0, middle: 1.0),
                  child:
                ...
                Pinned.fromPins(
                  Pin(startFraction: 0.0, endFraction: 0.0667),
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromPins(
                    Pin(startFraction: 0.3022, endFraction: 0.2928),
          ...
          Pinned.fromPins(
            Pin(start: 24.5, end: 18.5),
            Pin(size: 1.0, middle: 0.7411),
...
const String _svg_z5ws9i =
    '<svg viewBox="24.5 562.5 317.0 1.0" ><path transform="translate(24.5, 562.5)" d="M 0 0 L 317 0" fill="none" stroke="#707070" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
