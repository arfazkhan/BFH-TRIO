...
class ShirtsBothSmartCasual extends StatelessWidget {
  ShirtsBothSmartCasual({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(startFraction: 0.1583, endFraction: 0.6611),
          ...
          Pinned.fromPins(
            ...
            Pin(size: 40.3, end: 21.5),
            child: Component571(),
          ),
          Pinned.fromPins(
            Pin(start: 14.0, end: 14.6),
            Pin(size: 169.8, middle: 0.2398),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(size: 101.9, start: 0.0),
          ...
          Pinned.fromPins(
            Pin(start: 11.0, end: 11.3),
            Pin(size: 171.0, middle: 0.5484),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  ...
                  child: Stack(
                    children: <Widget>[
                      ...
                      Pinned.fromPins(
                        ...
                        child:
                            // Adobe XD layer: 'women semi casual 3' (shape)
                            Container(
                          decoration: BoxDecoration(
                            image: DecorationImage(
                              image: const AssetImage('assets/images/womensemicasual3.png'),
                              fit: BoxFit.fill,
                            ),
                          ),
                        ),
